...
- Novos anúncios de aluguel com preço, área, quartos e bairro
...
GitHub Actions (cron 6h)
  └─► scraper/scraper.py
        ...
        ├── extrai: título, preço, área, quartos, bairro, URL, imagem
...
### Aba 1: Anúncios
- Grid responsivo de cards com foto, fonte, preço, área, quartos, bairro
- Badge **NOVO** em anúncios da última execução
- Filtros: fonte, quartos, preço máximo (slider), somente novos
- Filtro por bairro ativado a partir do ranking (badge removível)
...
|---|---|---|
| OLX | `__NEXT_DATA__` JSON + fallback HTML | `props.pageProps.ads[]` |
| ZAP Imóveis | `__NEXT_DATA__` JSON | `props.pageProps.initialProps.search.result.listings[]` |
| Viva Real | `__NEXT_DATA__` JSON | mesmo schema do ZAP |
| Imovelweb | seletores HTML (`data-qa`) | `div[data-qa='posting PROPERTY']` |
